...
if __name__ == '__main__':
    ...
    # Callbacks
    model_path = os.path.join(wandb.run.dir, 'model/cp.ckpt')
    ...
    with open(os.path.join(wandb.run.dir, 'X_tokenizer.json'), 'w') as fp:
        json.dump(X_tokenizer.to_json(), fp, indent=4, sort_keys=False)
    np.save(os.path.join(wandb.run.dir, 'y_tokenizer.npy'), y_tokenizer.classes_)
